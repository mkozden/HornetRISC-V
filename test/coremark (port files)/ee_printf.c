...
char *      ecvtbuf(float arg, int ndigits, int *decpt, int *sign, char *buf);
char *      fcvtbuf(float arg, int ndigits, int *decpt, int *sign, char *buf);
...
static void
parse_float(float value, char *buffer, char fmt, int precision)
{
...
static char *
flt(char *str, float num, int size, int precision, char fmt, int flags)
{
    char tmp[80];
    char c, sign;
    int  n, i;
